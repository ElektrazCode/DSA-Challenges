/**ou walk in a maze. You need to reach the exit through many rooms. These rooms are in a straight line.
...
function bulbMaze(maze){
    return maze.split('').every((room, index) => (room!==' ') ? (index%2===0) ? room==='x' : room==='o' : room===' ');
   }