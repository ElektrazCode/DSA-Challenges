...
function minUmbrellas(weather) {
    ...
    return weather.reduce((totalUmbrellas, journey, index) => {
  
      if(journey==="rainy" || journey==="thunderstorms"){
          if(index % 2 === 0){
            if (atHome !== 0) atHome--;
            atWork++
          }
      ...
      console.log(`Journey: ${journey}, atHome: ${atHome}, atWork: ${atWork}, Umbrellas: ${totalUmbrellas}`);
